                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <button type="button" class="btn btn-info">
                                            <a href="javascript:$('#mainId').load('${path}/map/map.jsp')"> 用户分布图</a>
                                        </button>
                                    </li><br/>
                                    <li>
                                        <button type="button" class="btn btn-info">
                                            <a href="javascript:$('#mainId').load('${path}/month/month1.jsp')"> 用户注册图</a>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li>
                                        <button type="button" class="btn btn-success">
                                            <a href="javascript:$('#mainId').load('${path}/banner/banner.jsp')"> 轮播图</a>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li>
                                        <button type="button" class="btn btn-warning">
                                            <a href="javascript:$('#mainId').load('${path}/album/album.jsp')"> 专辑</a>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li>
                                        <button type="button" class="btn btn-primary">上师信息</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li>
                                        <button type="button" class="btn btn-primary">管理信息</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
